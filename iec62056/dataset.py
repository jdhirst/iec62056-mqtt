...
MEASURE_ELECTRICITY = {
    '0': 'General purpose',
    '1': 'Sum active power plus',
    '2': 'Sum active power minus',
    '3': 'Sum reactive power plus',
    '4': 'Sum reactive power minus',
    '5': 'Sum reactive power Q I',
    '6': 'Sum reactive power Q II',
    '7': 'Sum reactive power Q III',
    '8': 'Sum reactive power Q IV',
    '9': 'Sum apparent power plus',
    '10': 'Sum apparent power minus',
    '13': 'Power factor',
    '14': 'Frequency',
    '21': 'L1 active power plus',
    '22': 'L1 active power minus',
    '23': 'L1 reactive power plus',
    '24': 'L1 reactive power minus',
    '25': 'L1 reactive power Q I',
    '26': 'L1 reactive power Q II',
    '27': 'L1 reactive power Q III',
    '28': 'L1 reactive power Q IV',
    '29': 'L1 apparent power plus',
    '30': 'L1 apparent power minus',
    '31': 'L1 current',
    '32': 'L1 voltage',
    '33': 'L1 power factor',
    '41': 'L2 active power plus',
    '42': 'L2 active power minus',
    '43': 'L2 reactive power plus',
    '44': 'L2 reactive power minus',
    '45': 'L2 reactive power Q I',
    '46': 'L2 reactive power Q II',
    '47': 'L2 reactive power Q III',
    '48': 'L2 reactive power Q IV',
    '49': 'L2 apparent power plus',
    '50': 'L2 apparent power minus',
    '51': 'L2 current',
    '52': 'L2 voltage',
    '53': 'L2 power factor',
    '61': 'L3 active power plus',
    '62': 'L3 active power minus',
    '63': 'L3 reactive power plus',
    '64': 'L3 reactive power minus',
    '65': 'L3 reactive power Q I',
    '66': 'L3 reactive power Q II',
    '67': 'L3 reactive power Q III',
    '68': 'L3 reactive power Q IV',
    '69': 'L3 apparent power plus',
    '70': 'L3 apparent power minus',
    '71': 'L3 current',
    '72': 'L3 voltage',
    '73': 'L3 power factor',
    '81': 'Angles',
...
class DataSet(object):
    ...
    def __str__(self):
        billing_period = f' - {self.billing_period_display}' if self.billing_period else ''
        values = ', '.join([str(v) for v in self.values])
        return f'{self.medium_display} - {self.measure_display} - {self.mode_display}{billing_period}: {values}'
    ...
    def billing_period_display(self):
        return f'period {self.billing_period}'
